...
function getRecipe(queryURL) {
	...
	$.ajax({
		...
		var imageURL = (recipeData.matches[0].smallImageUrls[0]).slice(0,-2)+"500-c";
    ...
    imageSection.append('<span class="card-title">'+recipeData.matches[0].recipeName+'</span>');
...
$("#searchFood").on("click", function(){
  ...
  var queryURL = "http://api.yummly.com/v1/api/recipes?_app_id=78251404&_app_key=ae65a091779f9ce10b68bb9d74e5ebdf&q="+meat+"+"+ingredients+"&requirePictures=true&allowedCuisine[]=cuisine^cuisine-"+cuisine;
  getRecipe(queryURL);
